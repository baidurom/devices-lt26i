...
.method private getAppState(I)Lcom/android/internal/telephony/IccCard$State;
    ...
    :cond_1
    iget-object v1, v0, Lcom/android/internal/telephony/IccCardApplication;->pin2:Lcom/android/internal/telephony/IccCardStatus$PinState;
    ...
    .line 869
    iput-boolean v4, p0, Lcom/android/internal/telephony/IccCard;->mIccPin2Blocked:Z

    .line 870
    iput-boolean v3, p0, Lcom/android/internal/telephony/IccCard;->mIccPuk2Blocked:Z
    ...
    .line 872
    iput-boolean v4, p0, Lcom/android/internal/telephony/IccCard;->mIccPuk2Blocked:Z

    .line 873
    iput-boolean v3, p0, Lcom/android/internal/telephony/IccCard;->mIccPin2Blocked:Z
    ...
    sget-object v2, Lcom/android/internal/telephony/IccCardApplication$PersoSubState;->PERSOSUBSTATE_SIM_NETWORK:Lcom/android/internal/telephony/IccCardApplication$PersoSubState;
    ...
    const-string v3, "[IccCard] UnSupported De-Personalization, substate "
    ...
    const-string v3, " assuming ICC_NOT_READY"
...
.method private handleIccCardStatus(Lcom/android/internal/telephony/IccCardStatus;)V
    ...
    iput v8, p0, Lcom/android/internal/telephony/IccCard;->mAttemptsLeft:I
...
.method private onPinPukDone(Landroid/os/AsyncResult;)V
    ...
    const-string v3, "[IccCard] Bogus PIN PUK done response"
    ...
    .line 787
    .local v0, currentState:Lcom/android/internal/telephony/IccCard$State;
    const/4 v2, 0x0

    aget v2, v1, v2

    iput v2, p0, Lcom/android/internal/telephony/IccCard;->mAttemptsLeft:I
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/internal/telephony/IccCard;->broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V
...
.method private onQueryFdnEnabled(Landroid/os/AsyncResult;)V
    ...
    const-string v2, "Error in querying FDN enabled:"
    ...
    const-string v2, "Query FDN enabled : "
    ...
    const-string v1, "Query FDN enabled : FDN Service Unavailable!"
    ...
    const-string v2, "[IccCard] Bogus FDN enabled response"
...
.method public isIccPin2Blocked()Z
    .locals 1
...
.method public isIccPuk2Blocked()Z
    .locals 1
